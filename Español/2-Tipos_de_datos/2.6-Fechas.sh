...
echo -e "Ejemplos de uso del comando 'date':\n"

# 1. Obtener la fecha y hora actual
fecha_actual=$(date +"%Y-%m-%d")
hora_actual=$(date +"%H:%M:%S")
echo -e "Fecha actual: $fecha_actual"
echo -e "Hora actual: $hora_actual"

# 2. Formatear la salida de la fecha
fecha_formateada=$(date +"%A, %d de %B de %Y")
echo -e "Fecha formateada: $fecha_formateada" # Ejemplo: "viernes, 28 de diciembre de 2024"

# 3. Convertir una fecha específica a un timestamp
fecha_especifica="2024-12-31"
timestamp=$(date -d "$fecha_especifica" +"%s")
echo -e "Timestamp para $fecha_especifica: $timestamp"
...
mes=$(date +"%m")
día=$(date +"%d")
echo -e "Año: $año, Mes: $mes, Día: $día"

# 9. Ejemplo de temporizador
echo -e "Iniciar temporizador (3 segundos)..."
sleep 3
echo -e "¡Temporizador terminado!"

# 10. Conversión de zonas horarias
hora_utc=$(date -u +"%Y-%m-%d %H:%M:%S")
hora_local=$(date +"%Y-%m-%d %H:%M:%S")
echo -e "Hora UTC: $hora_utc"
echo -e "Hora Local: $hora_local"
