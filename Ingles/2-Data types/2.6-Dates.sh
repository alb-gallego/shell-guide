...
echo "Examples of using the 'date' command:\n"
...
echo "Formatted Date: $formatted_date" # e.g., "Friday, December 28, 2024"

# 3. Convert a specific date to a timestamp
specific_date="2024-12-31"
timestamp=$(date -d "$specific_date" +"%s")
echo "Timestamp for $specific_date: $timestamp"
...
echo "Readable Date for timestamp $timestamp_to_convert: $readable_date"
